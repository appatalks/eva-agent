...
python3 tools/tests/test_audit_log.py
...
node tools/tests/test_email_settings.js
node tools/tests/test_runtime_logger.js
node tools/tests/test_runtime_log_wiring.js
