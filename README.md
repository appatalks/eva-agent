...
./dist/'Eva Standalone-5.5.6.AppImage' --eva-workspace-terminal-v1
```
...
| **Voice interface** | Full-screen voice orb, wake/barge-in, TTS (OpenAI, Polly, Local Voices, browser), persisted microphone/speaker selection, and cached Local Voices acknowledgement clips in Standalone |
