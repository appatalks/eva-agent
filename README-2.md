...
> **Current release:** Eva 5.5.6. This document describes the matching browser UI,
...
standalone/
  ...
  package.json             Electron + electron-builder config (v5.5.6)
```
...
npm install
npm run dist
./dist/'Eva Standalone-5.5.6.AppImage'
