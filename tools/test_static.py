...
def test_pr_automation_workflows():
    ...
    try:
        ...
        return
    report("pr_automation_readiness_base_only", "workflow_run:" in readiness and 'workflows: ["Eva CI", "Secret Scanning Status Check", "CodeQL"]' in readiness and "pull_request:" not in readiness and "pull_request_target:" not in readiness and "workflow_dispatch:" in readiness and "base_sha" in readiness and "gh pr diff" in readiness and "workflow_run.head_sha" in readiness and "persist-credentials: false" in readiness and "Fetch restricted readiness agent" in readiness and "ref: ${{ github.sha }}" in readiness and "path: readiness-agent-source" in readiness and "Install restricted readiness agent" in readiness and "readiness-agent-source/.github/agents/readiness-reviewer.agent.md" in readiness and ".github/agents/readiness-reviewer.agent.md" in readiness and "rm -rf readiness-agent-source" in readiness)
