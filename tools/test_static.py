...
def test_pr_automation_workflows():
    ...
    try:
        ...
        return
    report("pr_automation_readiness_base_only", "workflow_run:" in readiness and 'workflows: ["Eva CI", "Secret Scanning Status Check", "CodeQL"]' in readiness and "pull_request:" not in readiness and "pull_request_target:" not in readiness and "workflow_dispatch:" in readiness and "gh pr diff" in readiness and "workflow_run.head_sha" in readiness and "persist-credentials: false" in readiness and "no PR commit is checked out or executed here" in readiness and "ref: ${{ needs.prepare.outputs" not in readiness and "readiness-agent-source" not in readiness)
