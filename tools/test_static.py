...
def test_pr_automation_workflows():
    ...
    report("pr_automation_verdict_gate", "name: PR Readiness / Terra verdict" in readiness and "Gate Terra verdict" in readiness and "REQUEST_CHANGES" in readiness and "NEEDS_MAINTAINER" in readiness and "if: always()" in readiness and "Publish readiness in progress" in readiness and "Publish trusted metadata failure" in readiness and "statuses: write" in readiness and "statuses/$HEAD_SHA" in readiness and "Terra approved PR readiness" in readiness and "Publish unexpected readiness failure" in readiness and "status_published" in readiness and "steps.credential_scan.outcome != 'failure'" in readiness and "Readiness workflow execution failed" in readiness and "group: pr-readiness-review-${{ needs.prepare.outputs.head_sha }}" in readiness and readiness.count("current_head=\"$(gh api") >= 4 and "skipping stale readiness status" in readiness and "copilot-review.md >> \"$GITHUB_STEP_SUMMARY\"" not in readiness and "Verdict: APPROVE" in readiness)
