...
def test_coding_workspace_contract():
    ...
    report("coding_workspace_github_branch_delete_provenance", "direct_native_inspection" in harness_control and "aigMessages" not in harness_control[harness_control.index("function recentPullRequestContext"):harness_control.index("function resolveNavigationRequest")])
