...
def test_pr_automation_workflows():
    ...
    report("pr_automation_verdict_gate", "name: PR Readiness / Terra verdict" in readiness and "Gate Terra verdict" in readiness and "REQUEST_CHANGES" in readiness and "NEEDS_MAINTAINER" in readiness and "if: always()" in readiness and "Publish readiness in progress" in readiness and "Publish trusted metadata failure" in readiness and "statuses: write" in readiness and "statuses/$HEAD_SHA" in readiness and "Terra approved PR readiness" in readiness and "Publish unexpected readiness failure" in readiness and "status_published" in readiness and "touch readiness/status-published" in readiness and "An authoritative Terra status was already published" in readiness and "invalid_verdict=true" in readiness and "terra-verdict-diagnostic.json" in readiness and "response_sha256" not in readiness and "--diagnostic-output readiness/terra-verdict-diagnostic.json" in readiness and "steps.credential_scan.outcome != 'failure'" in readiness and "Readiness workflow execution failed" in readiness and "group: pr-readiness-review-${{ needs.prepare.outputs.head_sha }}" in readiness and readiness.count("current_head=\"$(gh api") >= 4 and "skipping stale readiness status" in readiness and "copilot-review.md >> \"$GITHUB_STEP_SUMMARY\"" not in readiness and "Verdict: APPROVE" in readiness and readiness.count("tools/readiness_verdict.py") == 3 and "sed -nE 's/^VERDICT:" not in readiness and "python3 - \"$response_kind\"" not in readiness and os.path.isfile("tools/readiness_verdict.py"))
