...
def test_coding_workspace_contract():
    ...
    report("coding_workspace_agent_auto_permission", 'permission_mode == "workspace_write"' in acp_client and 'tool_kind in {"read", "search", "fetch", "think"}' in acp_client and 'decision="workspace-auto-allow"' in acp_client and 'workspace-auto-allow-read-execute' in acp_client and 'auto-allow-read-execute' in acp_client and 'def _workspace_read_only_execute' in acp_client and '_WORKSPACE_READ_ONLY_COMMANDS' in acp_client and 'find' not in acp_client.split('_WORKSPACE_READ_ONLY_COMMANDS =', 1)[1].split('\n', 1)[0] and 'permission_mode=permission_mode' in workspace_utils)
