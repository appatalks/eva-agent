...
def test_coding_workspace_contract():
    ...
    report("coding_workspace_preload_allowlist", all(value in standalone_preload for value in ("terminalCloseRoot", "workspaceListProjects", "workspaceSelectProject", "workspaceImportGitHub", "workspaceGitHubAuthStart", "workspaceGitHubAuthStatus", "githubMergePullRequest", "workspaceRemediationContextLoad", "workspaceRemediationContextSave", "workspaceSetMcpServer", "workspaceCreateRun", "workspaceDispatchRun", "workspaceCheckoutStatus", "workspaceRunAction")))
