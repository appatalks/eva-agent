...
def test_coding_workspace_contract():
    ...
    report("direct_acp_autonomy", 'acp_auto_approve' not in open("core/js/providers/aig.js").read() and 'acp_auto_approve' not in open("core/js/providers/copilot.js").read() and 'acp_auto_approve' not in open("core/js/cognition.js").read())
