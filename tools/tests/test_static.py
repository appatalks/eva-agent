...
def test_coding_workspace_contract():
    ...
    report("coding_workspace_preload_allowlist", all(value in standalone_preload for value in ("terminalCloseRoot", "workspaceListProjects", "workspaceSelectProject", "workspaceImportGitHub", "workspaceGitHubAuthStart", "workspaceGitHubAuthStatus", "workspaceRemediationContextLoad", "workspaceRemediationContextSave", "workspaceSetMcpServer", "workspaceCreateRun", "workspaceDispatchRun", "workspaceCheckoutStatus", "workspaceRunAction")))
    ...
    report("coding_workspace_live_chat_drawer", all(value in html for value in ("workspaceChatToggleBtn", "workspaceChatDrawer", "workspaceChatOutputHost", "workspaceChatInputHost")) and "setChatDrawerOpen" in workspace_ui and "captureChatNodeOrigins" in workspace_ui and "restoreChatNodes" in workspace_ui and "workspace-chat-drawer-open" in style_css and ".workspace-chat-drawer" in style_css)
