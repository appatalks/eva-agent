...
def test_coding_workspace_contract():
    ...
    report("coding_workspace_agent_auto_permission", 'permission_mode == "workspace_write"' in acp_client and 'tool_kind in {"read", "search", "fetch", "think", "edit"}' in acp_client and 'decision="workspace-auto-allow-execute"' in acp_client and 'def _workspace_sensitive_execute' in acp_client and '_WORKSPACE_SENSITIVE_COMMANDS' in acp_client and 'def _command_summary' in acp_client and 'permission_mode=permission_mode' in workspace_utils)
