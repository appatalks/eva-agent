...
def test_pr_automation_workflows():
    ...
    try:
        ...
        return
    report("pr_automation_readiness_base_only", "workflow_run:" in readiness and 'workflows: ["Eva CI", "Secret Scanning Status Check", "CodeQL"]' in readiness and "pull_request:" not in readiness and "pull_request_target:" not in readiness and "workflow_dispatch:" in readiness and "head_sha:" in readiness and "Current PR head SHA" in readiness and "actual_head_sha" in readiness and "The dispatched head SHA is stale" in readiness and "PR head changed while resolving readiness" in readiness and "gh pr diff" in readiness and "actions: read" in readiness and "WORKFLOW_RUN_ID" in readiness and "actions/runs/$WORKFLOW_RUN_ID" in readiness and "workflow-run-prs.json" in readiness and "WORKFLOW_RUN_PULL_REQUESTS" not in readiness and "workflow_run.head_sha" not in readiness and "ref: ${{ github.event.repository.default_branch }}" in readiness and "persist-credentials: false" in readiness and "no PR commit is checked out or executed here" in readiness and "ref: ${{ needs.prepare.outputs" not in readiness and "readiness-agent-source" not in readiness)
