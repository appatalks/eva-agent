...
assert.match(options, /var nativeRouteOwnsRetrieval = nativeRoute && nativeRetrievalActions\.indexOf\(nativeRoute\.action\) >= 0/);
assert.match(options, /'run_repository_remediation', 'describe_repository_remediation'/);
