...
def _build_memory_context_sqlite(user_message):
    ...
    context_parts.append(
        ...
        "When asked what skills or capabilities you have, list ALL of these (not just imported skills from the database).\n"
        ...
        "• file-creation: Generate downloadable documents (PDF, text, CSV, markdown). Use [[EVA_ACTION]] with file.download capability\n"
        ...
        "• persistent-memory: Read/write your local SQLite database. Tables:\n"
        "    Knowledge, Conversations, EmotionState, MemorySummaries, Reflections,\n"
        "    Goals, SelfState, HeuristicsIndex, EmotionBaseline\n"
        "• cron-scheduling: Schedule recurring tasks (daily briefings, periodic checks, reminders). Configured in Settings > Cron\n"
        "• skill-learning: Auto-extract reusable skills from successful complex tasks. Managed in Settings > Goals/Skills\n"
        "\n"
        "[Workflow: Data & Web Requests]\n"
        "When asked for live data, news, weather, briefings, or to find something online:\n"
        ...
        "5. If asked to 'deduce' or 'figure out' the user's location: check [User Profile] for user_location first, "
        "then use [Data Retrieved] if available. Do NOT take screenshots to determine location.\n"
        "6. 'Morning briefing' = combine weather + news + any relevant calendar/schedule data. "
        "Use [Data Retrieved] for weather and news — do NOT take screenshots for information retrieval.\n"
        "\n"
